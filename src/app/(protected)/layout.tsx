    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      {!isAdmin && (
        <button
          ...
          className="fixed bottom-6 right-6 p-3 bg-slate-700 border border-slate-500 rounded-full text-slate-300 hover:text-white hover:bg-slate-600 transition-colors z-30 shadow-lg"
          title="관리자 모드"
        >
